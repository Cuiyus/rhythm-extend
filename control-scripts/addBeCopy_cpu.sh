#!/bin/bash
#python /home/tank/iBench-master/predictRequest.py  


#cd /home/tank/CycleGAN-TensorFlow-master 
#python /home/tank/CycleGAN-TensorFlow-master/train.py 
...
/home/tank/iBench-master/src/cpu 31536000 &
starttime=$(date +%s%3N)
